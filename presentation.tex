...
\begin{frame}[plain]
  \vspace*{\fill}
  \centering
  {\Large\bfseries\color{accBlack}Attention interaktivně.}\\[6mm]
  {\normalsize\color{mutedText}Moje appka, kde si attention osaháte.}\\[8mm]
  \begin{minipage}{0.55\textwidth}\centering
...
\begin{frame}[t]{Perplexita $-$ ,,jak moc je model překvapený?''}
  ...
  \vspace{3mm}
  \begin{aha}
  \small PPL je \textbf{kompas}. Sama o~sobě nestačí (nezachytí ,,jak moc to zní jako Poe''), ale řekne, \emph{jestli adaptér/hlava vůbec hraje}.
  \end{aha}
\end{frame}
...
% ═══════════════════ P5f: Sweep dominantní hlavy — Minimalist ═══════════════════
\begin{frame}[t]{Sweep dominantní hlavy: Minimalist $\times$ H11}
  \vspace{2mm}
  {\small Stejný prompt ,,It was a dark and stormy``, seed 42. Dominantní hlava škálovaná $0\times$ až $2\times$.}\par\vspace{1mm}
  {\footnotesize\color{mutedText}\itshape Recovery 0.37, PPL spike $+77\%$ při $0\times$.}\par\vspace{4mm}

  {\small
  \begin{quotebox}
    \qlabel{$0\times$:} ,,I was not ready,'' said the wind. ,,Don't worry, we can stay in the storm. I'm strong,'' said the storm. But Lily made sure to stay inside\ldots\par
    \vspace{1mm}{\footnotesize\color{mutedText}\itshape dialogy, normální věty}
  \end{quotebox}
  \begin{quotebox}[featTeal!18]
    \qlabel{$1\times$:} The trees began to tremble. When the storm was over, the people were scared. The wind was so strong that it made the storm bad.\par
    \vspace{1mm}{\footnotesize\color{mutedText}\itshape kratší věty}
  \end{quotebox}
  \begin{quotebox}[accRed!12]
    \qlabel{$2\times$:} It was cold and sad. He looked inside the shop. It was cold and wet. It had a hole. Tom looked. It saw a sign. It said. It was a shop.\par
    \vspace{1mm}{\footnotesize\color{mutedText}\itshape sekané, extrém}
  \end{quotebox}
  }
\end{frame}
