...
\begin{frame}[t]{Zapnu feature $-$ změní se text.}
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.56\textwidth}
      ...
      {\scriptsize
      \begin{quotebox}
        \qlabel{baseline:} a tiny little little voice. The bunny hopped along, and looked around, and saw an old man standing behind the bush. Alice took him in the little house and said, ,,Oh, I wonder how the bunny is\ldots''
      \end{quotebox}
      \begin{quotebox}
